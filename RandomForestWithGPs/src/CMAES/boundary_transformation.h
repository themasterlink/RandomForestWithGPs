...
#ifndef CMAES_BOUNADRIES_H
#define CMAES_BOUNADRIES_H

namespace cmaes {

struct cmaes_boundary_transformation_t {
	double *lower_bounds; /* array of size len_of_bounds */
	double *upper_bounds; /* array of size len_of_bounds */
