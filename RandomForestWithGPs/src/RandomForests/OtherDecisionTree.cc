...
OtherDecisionTree::OtherDecisionTree(const int maxDepth,
...
void OtherDecisionTree::train(const Data& data,
	const Labels& labels,
...
double OtherDecisionTree::trySplitFor(const int actNode,
